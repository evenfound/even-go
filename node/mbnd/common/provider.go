...
// SupportedProvider returns a slice of strings that represent the database
// providers that have been registered and are therefore supported.
func SupportedProvider() []string {
...
func Init(token string) (Blockchain, error) {
